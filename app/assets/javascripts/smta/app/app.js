	...
	$(document).ready(function() {
	    ...
	    $('#logout a').click(function(e) {
	        ...
	        // ask verification
	        $.SmartMessageBox({
	            title: "<i class='fa fa-sign-out txt-color-orangeDark'></i> 退出 MakeSlide <span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
	            content: $.logoutMSG || "您将在当前浏览器中退出MakeSlide，请选择是否继续？",
	            buttons: '[No][Yes]'
